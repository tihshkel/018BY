/**
 * Page 44 «Анкета родов» — manual slots from iOS e24a739
 * (in albums/беременность A5/44.pdf).
...
const PAGE_44_SLOTS = [
  ...
  // Время: block (не LINE), иначе textAlign/вертикаль — сверху-слева.
  // Band сохранён с iOS; H/V-центр — в getPregnancyBirthQuestionnaireBlockTextTop (только A5).
  FILL(0.22, 0.536, 0.32, 0.026, 14, true),
